...
Все новые модули после 2026-XX-XX (дата принятия этого правила) реализуются сразу через API — без промежуточного этапа с моками.
---
...
### Единый формат запросаGET /api/<resource>?page=1&size=20&search=...&<filters>
