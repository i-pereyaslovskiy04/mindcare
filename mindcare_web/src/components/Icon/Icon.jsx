export default function Icon({ name, size = 18, stroke = 1.5 }) {
  ...
  switch (name) {
    ...
    case 'more-vertical':
      return <svg {...props} fill="currentColor" stroke="none"><circle cx="12" cy="5" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="12" cy="19" r="1.6"/></svg>;
    case 'tag':
    ...
    case 'news':
      return <svg {...props}><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8M15 18h-5M10 6h8v4h-8V6z"/></svg>;
    case 'folder':
    ...
    case 'power':
      return <svg {...props}><path d="M12 2v10" /><path d="M18.36 6.64a9 9 0 1 1-12.73 0" /></svg>;
    default:
      return null;
  }
}
