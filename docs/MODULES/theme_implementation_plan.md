...
**Палитры:** ДонГУ (`dongu`, фирменная бело-синяя гамма Донецкого
государственного университета, **по умолчанию**), Кофейная (`coffee`, прежний
дизайн сайта), Природная (`nature`), Классическая (`classic`, бело-синяя),
Контраст (`hc`, AAA ≥ 7:1).
...
палитра `hc`, иначе `dongu`).
**Итог:** 10 тем — `data-theme="{palette}-{light|dark}"`.
